describe('middleware test for scrum master', () => {
    before(() => {
        cy.refreshDatabase();
        cy.seed();
    ...
    beforeEach(() => {
        cy.login({email:'scrummaster@justacompany.com'});
    });
